...
lval_t* lval_table_copy(lval_t* v) {
...
void lval_table_set(lval_t* t, lval_t* k, lval_t* v) {
...
lval_t* lval_table_get(lval_t* t, lval_t* k) {
  lval_t* x = NULL;
...
lval_t* lval_table_len(lval_t* a) {
